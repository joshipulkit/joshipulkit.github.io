---
# This file is a template. published: false keeps it out of the build.
# Copy it to e.g. `_teachings/2024-qm2.md`, set `published: true`,
# and fill in the fields below. Only `title` and `year` are required.
...
You can drop notes, syllabi, slide links, etc. here.
